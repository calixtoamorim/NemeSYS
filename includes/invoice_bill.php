...
if ($_GET["order_date"] && $_GET["invoice_no"]) {
	...
	$pdf->Cell(190,10,"Sistema de Inventário",0,1,"C");
	$pdf->setFont("Arial",null,12);

	$pdf->Cell(50,10,"Data",0,0);
	...
	$pdf->Cell(50,10,"Impostos",0,0);
	$pdf->Cell(50,10,": ".$_GET["gst"],0,1);
	$pdf->Cell(50,10,"Descontos",0,0);
	$pdf->Cell(50,10,": ".$_GET["discount"],0,1);
	$pdf->Cell(50,10,"Total Líquido",0,0);
	...
	$pdf->Cell(50,10,"Forma de Pagamento",0,0);
	$pdf->Cell(50,10,": ".$_GET["payment_type"],0,1);


	$pdf->Cell(180,10,"Assinatura",0,0,"R");
