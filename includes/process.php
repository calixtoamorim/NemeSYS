		...
		foreach ($rows as $row) {
			?>
				<tr>
			        ...
			        <td><a href="#" class="btn btn-success btn-sm">Ativo</a></td>
			        <td>
			        	<a href="#" did="<?php echo $row['cid']; ?>" class="btn btn-danger btn-sm del_cat">Deletar</a>
		...
		foreach ($rows as $row) {
			?>
				<tr>
			        ...
			        <td><a href="#" class="btn btn-success btn-sm">Ativo</a></td>
			        <td>
			        	<a href="#" did="<?php echo $row['bid']; ?>" class="btn btn-danger btn-sm del_brand">Deletar</a>
			        	<a href="#" eid="<?php echo $row['bid']; ?>" data-toggle="modal" data-target="#form_brand" class="btn btn-info btn-sm edit_brand">Editar</a>
			        </td>
			      </tr>
			<?php
			$n++;
		...
		foreach ($rows as $row) {
			?>
				<tr>
			        ...
			        <td><a href="#" class="btn btn-success btn-sm">Ativo</a></td>
			        <td>
			        	<a href="#" did="<?php echo $row['pid']; ?>" class="btn btn-danger btn-sm del_product">Deletar</a>
